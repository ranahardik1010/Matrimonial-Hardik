   ...
   <aside id="left-panel" class="left-panel">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="state-form">
            <form action="editstatepro.php" method="post">
                <div class="form-group">
                   
                    <input type="text" class="form-control" name="id" value="<?php echo $row1['Stid']?>"hidden>
                </div>
                <div class="form-group">
                    <label>Add State</label>
                        <input type="text" class="form-control" name="Statename" value="<?php echo $row1['Name']?>">
                </div>
