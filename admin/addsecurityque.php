...
<body>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Add Security Question</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="state-form">
            <form id="addsecqueform" method="post">
                <div class="form-group">
                    <label>Add Security Question</label>
                        <input type="text" class="form-control" name="Secque" placeholder="Enter Security Question" required>
                </div>

                <button type="submit" id="submitsecque" name="submitsecque" class="btn btn-success">Add Security Question</button>
            </form>
        </div>
