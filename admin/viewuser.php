                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown active">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-plus"></i><a href="viewuser.php">View User</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">State Table</strong>
                            </div>
                            <div class="card-body">
                                        ...
                                        ?>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><a href="changeuser.php?id=<?php echo $row['Uid']?>">Change</a></td>
                                                    </tr>
                                                </tbody>
                                        <?php
                                                }
