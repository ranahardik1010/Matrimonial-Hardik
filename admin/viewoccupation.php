                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">View Occupation</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Occupation Table</strong>
                            </div>
                            <div class="card-body">
                                        ...
                                        ?>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><a href="changeoccupation.php?id=<?php echo $row['Oid']?>">Change</a></td> 
                                                    </tr>
                                                </tbody>
                                        <?php
                                                }
