...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="state-form">
            <form id="addoccupation" action="addoccprocess.php" method="post">
                <div class="form-group">
                    <label>Add Occupation</label>
                        <input type="text" class="form-control" name="Occupation" placeholder="Enter Occuption Name" required>
                </div>

                <button type="submit" id="submitocc" name="submitocc"  class="btn btn-success">Add Occupation</button>
            </form>
        </div>
