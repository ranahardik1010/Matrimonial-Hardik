...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="state-form">
            <form id="addreligion" action="addrelprocess.php" method="post">
                <div class="form-group">
                    <label>Add Religion</label>
                        <input type="text" class="form-control" name="Religion" placeholder="Enter Religion Name" required>
                </div>

                <button type="submit" class="btn btn-success"id="submitrel" name="submitrel">Add Religion</button>
            </form>
        </div>
